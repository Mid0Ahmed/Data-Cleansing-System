...
function storeSelectedOption(selectId) {
...
function setSelectedOption(selectId) {
  const selectElement = document.getElementById(selectId);
  if (selectElement) {
    const selectedOption = localStorage.getItem(selectId);
    if (selectedOption) {
...
storeSelectedOption('tableSelect');
storeSelectedOption('columnSelect');

window.addEventListener('DOMContentLoaded', function () {
  setSelectedOption('tableSelect');
  setSelectedOption('columnSelect');
});
